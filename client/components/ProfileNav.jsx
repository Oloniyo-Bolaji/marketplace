...
const ProfileNav = () => {
  return (
    <nav className="w-full h-[70px] flex-between sm:px-[50px] px-[10px]">
      ...
      <div className="flex items-center gap-[10px] sm:text-[30px] text-[15px]">
        <IconTooltip title="Settings" icon={<IoMdSettings />} link="/settings"/>
        <IconTooltip title="Dashboard" icon={<MdSpaceDashboard />} link="/dashboard"/>
      </div>
    </nav>
  );
};
